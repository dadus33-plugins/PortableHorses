...
public class Storage {
    ...
    public Storage(Config cfg, CustomConfig handler){
        ...
        switch(conf.getString("General.mode")){
            case "TAKEOFF": this.MODE = "TAKEOFF"; break;
            case "RIGHTCLICK": this.MODE = "RIGHTCLICK"; break;
            default:
        ...
        switch(conf.getString("General.auto-saddle-fallback-method").toUpperCase()){
            case "HORSE": this.AUTO_SADDLE_FALLBACK_OPTION = "HORSE"; break;
            case "FIRSTITEM": this.AUTO_SADDLE_FALLBACK_OPTION = "FIRSTITEM"; break;
            case "GROUND": this.AUTO_SADDLE_FALLBACK_OPTION = "GROUND"; break;
            default:
                Bukkit.getLogger().log(Level.WARNING, ChatColor.translateAlternateColorCodes('&',
                        "&cInvalid value found in plugins/PortableHorses/config.yml on field " +
                                "\"General.auto-saddle-fallback-option\". Found \""+conf.getString("General.auto-saddle-fallback-option")+"\" while" +
        ...
        switch(take_off_full_inv_mode.toUpperCase()){
            case "GROUND": this.TAKE_OFF_FULL_INV_MODE = "GROUND"; break;
            case "CANCEL": this.TAKE_OFF_FULL_INV_MODE = "CANCEL"; break;
            case "FIRSTITEM": this.TAKE_OFF_FULL_INV_MODE = "FIRSTITEM"; break;
            default:
                Bukkit.getLogger().log(Level.WARNING, ChatColor.translateAlternateColorCodes('&',
                        "&cInvalid value found in plugins/PortableHorses/config.yml on field " +
        ...
        this.MESSAGES_AUTO_SADDLE_FIRST_ITEM_REPLACED = color(conf.getString("Messages.auto-saddle-first-item-replaced"));
