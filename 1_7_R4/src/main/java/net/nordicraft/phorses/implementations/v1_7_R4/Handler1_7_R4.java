package net.nordicraft.phorses.implementations.v1_7_R4;
...
public class Handler1_7_R4 extends NMSHandler {
	...
	public ItemStack setSpecialSaddle(ItemStack saddle) {
		net.minecraft.server.v1_7_R4.ItemStack nmsSaddle = CraftItemStack.asNMSCopy(saddle);
