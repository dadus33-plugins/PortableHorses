package net.nordicraft.phorses.implementations.v1_13_R1;
...
public class Handler1_13_R1 extends NMSHandler {
	...
	public ItemStack setSpecialSaddle(ItemStack saddle) {
		net.minecraft.server.v1_13_R1.ItemStack nmsSaddle = CraftItemStack.asNMSCopy(saddle);
