package net.nordicraft.phorses.implementations.v1_16_R2;
...
public class Handler1_16_R2 extends NMSHandler {
	...
	public ItemStack setSpecialSaddle(ItemStack saddle) {
		net.minecraft.server.v1_16_R2.ItemStack nmsSaddle = CraftItemStack.asNMSCopy(saddle);
