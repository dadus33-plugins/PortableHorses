package net.nordicraft.phorses.implementations.v1_16_R1;

import org.bukkit.craftbukkit.v1_16_R1.entity.CraftAbstractHorse;
...
public class Handler1_16_R1 extends NMSHandler {

	@Override
	public ItemStack transferTag(LivingEntity horse, ItemStack saddle) {
		net.minecraft.server.v1_16_R1.ItemStack nmsSaddle = CraftItemStack.asNMSCopy(saddle);
